      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="mb-8">
          <div className="inline-block mb-3 px-4 py-1 rounded-full bg-purple-600/20 border border-purple-600/30">
            <span className="text-purple-400 text-sm font-semibold">Test Suite Generation</span>
          </div>
          <h1 className="text-3xl font-mono font-bold mb-4 text-purple-400">Test Case Generator</h1>
          <p className="text-purple-300">Generate comprehensive test cases for your smart contracts using different testing frameworks</p>
          <AnimatePresence>
            {error && (
              <motion.div
              ...
              {TESTING_OPTIONS.map((option) => (
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    <div className={`${selectedFramework === option.id ? 'text-purple-400' : 'text-purple-300'}`}>
                      {option.icon}
                    </div>
                    <span className="font-semibold text-white">{option.name}</span>
                  </div>
                  <p className="text-xs text-purple-300 mb-2">{option.description}</p>
                </button>
              ))}
            </div>

            <div
              className="bg-purple-950/30 rounded-lg border border-purple-900 hover:border-purple-600/50 transition-colors duration-300 shadow-lg"
            >
              ...
              <textarea
                ...
                className="w-full h-[400px] bg-transparent p-6 font-mono text-sm resize-none focus:outline-none focus:border-purple-600 focus:ring-1 focus:ring-purple-600/50 transition-all duration-200 text-white"
              />
            </div>
            ...
            <div className="flex-1 bg-purple-950/30 rounded-lg border border-purple-900 hover:border-purple-600/50 transition-colors duration-300 shadow-lg">
              <div className="p-4 border-b border-purple-900 flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <TestTube className="text-purple-400" size={20} weight="duotone" />
                ...
                {generatedTests ? (
                  ...
                  <div className="h-full flex flex-col items-center justify-center text-purple-300">
                    <div className="relative">
                      ...
                      <TestTube size={48} className="mb-4 relative z-10 text-purple-400" weight="duotone" />
                    </div>
